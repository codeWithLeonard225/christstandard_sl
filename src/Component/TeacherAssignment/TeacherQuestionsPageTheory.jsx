...
const TeacherQuestionsPageTheory = () => {
    ...
    useEffect(() => {
        ...
        const q = query(
            collection(db, "TheoryQuestionsBank"), // <--- Changed collection name
            where("schoolId", "==", schoolId),
    ...
    const handleDeleteQuestion = async (questionToDelete, index) => {
        ...
        try {
            const docRef = doc(db, "TheoryQuestionsBank", existingDocId); // <--- Changed collection
    ...
    const handleSubmitQuestions = async () => {
        ...
        try {
            ...
            const docRef = existingDocId
                ? doc(db, "TheoryQuestionsBank", existingDocId) // <--- Changed collection
                : doc(collection(db, "TheoryQuestionsBank")); // <--- Changed collection
