...
const initialResultData = {
    ...
    indexNumber: " ................................................................",
    date: "N/A",
    schoolName: "CHRIST STANDARD SECONDARY SCHOOL",
    schoolAddress: "19 STATION ROAD, HASTINGS FREETOWN. Tel +23232 101862 / +23275101605",
    pupilImgUrl: "/images/me.jpg", // Default placeholder
    schoolLogoUrl: "/images/CSSSBADGE.jpg", // Default placeholder
    core: {
...
const BECEStatementOfResult = () => {
    ...
    const handleSearch = useCallback(async (e) => {
        ...
        try {
            ...
            const resultsRef = collection(db, "BECE_Results");
            const q = query(
                resultsRef,
    ...
    const handleDownloadPDF = async () => {
        ...
        // ===================================================================
        // 🚨 STEP 1: RESOLVE IMAGE URLs to BASE64 DATA
        // In a real application, you must convert the image URLs (data.pupilImgUrl, data.schoolLogoUrl) 
        // to a Base64 string synchronously or asynchronously before calling doc.addImage.
        // For this example, we'll assume the URLs are resolved or hardcoded Base64.
        // ===================================================================
        // For simplicity and to avoid complex async/CORS issues in a minimal example, 
